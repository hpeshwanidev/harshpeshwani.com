...
<div class="fixed top-4 left-1/2 z-50 transform -translate-x-1/2 hidden md:block">
	<div class="bg-black/20 backdrop-blur-sm px-4 py-2 rounded-2xl flex items-center gap-1 text-gray-700 dark:text-white shadow-lg">
	  ...
	  <a href="/" class="flex items-center gap-2 px-3 py-2 rounded-xl transition-colors hover:bg-white/20 focus:outline-none focus:ring-2 focus:ring-white/20">
		<div class="flex items-center justify-center w-8 h-8 bg-black/10 rounded-full text-gray-800 dark:text-gray-100">
		  <!-- Home SVG -->
