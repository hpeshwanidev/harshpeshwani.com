	...
	const projects = [
		{
			...
			tags: ['SvelteKit', 'Tailwind CSS', 'JavaScript', 'React', 'Vite'],
			link: 'https://harshpeshwani.com'
		},
		{
			title: 'Portfolio Website – Personal Showcase',
			description:
...
<!-- Main Content -->
<div class="relative z-10 min-h-screen text-white flex flex-col justify-center items-center px--1 py-20">
	<div class="max-w-7xl mx-auto w-full">
		<!-- Title -->
		<div class="text-center mb-10">
			<h1 class="text-3xl md:text-4xl font-bold mb-5 bg-gradient-to-r from-blue-400 to-cyan-400 text-transparent bg-clip-text">
				Projects
			</h1>
				...
				>
					...
					<div class="flex flex-wrap gap-2 mb-5">
						{#each project.tags as tag}
							<span class="px-3 py-1 text-xs font-medium rounded-full bg-neutral-800/70 text-blue-400 border border-neutral-700 hover:bg-blue-500/20 hover:text-blue-300 transition-all duration-300">
								{tag}
							</span>
						{/each}
					</div>
					...
					<a
						...
						class="inline-flex items-center px-2 py-1 bg-blue-600/20 hover:bg-blue-600/40 text-blue-400 hover:text-blue-300 rounded-lg transition-all duration-300 border border-blue-500/30 hover:border-blue-500/60 group-hover:shadow-lg group-hover:shadow-blue-500/20 no-underline"
					>
